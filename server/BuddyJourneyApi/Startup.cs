...
namespace BuddyJourneyApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                ...
                .AddJwtBearer(x =>
                {
                    ...
                    x.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(
                            Encoding.ASCII.GetBytes(Configuration.GetSection("JwtKey").ToString() ?? string.Empty)),
                        ValidateIssuer = true,
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BuddyJourneyApi", Version = "v1" });
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    BearerFormat = "JWT",
                    Scheme = "bearer",
                    In = ParameterLocation.Header,
                    Description = "Please JWT in Bearer into field",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BuddyJourneyApi v1"));
            }
